...
const PrinterIcon = ({ active }: { active: boolean }) => <NavIcon active={active} d="M5 2a1 1 0 00-1 1v3h12V3a1 1 0 00-1-1H5zM3 7a2 2 0 00-2 2v4a2 2 0 002 2h1v-3a1 1 0 011-1h10a1 1 0 011 1v3h1a2 2 0 002-2V9a2 2 0 00-2-2H3zm3 9v2a1 1 0 001 1h6a1 1 0 001-1v-2H6z" />;
...
const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      { href: "/printer",    label: "Printer",      icon: PrinterIcon },
    ],
  },
  {
    label: "Menu & Stock",
...
const STAFF_ROUTES = ["/pos", "/kitchen", "/till", "/printer"];
